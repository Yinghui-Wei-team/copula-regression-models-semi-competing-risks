...
for (i in 1:runs){
  ...
  #                     true_b0, true_b1, true_b2, true_b3), cpl, method="L-BFGS-B", 
...
#variance: corrected by YW 26/June/2021
...
#variance: corrected by YW 26/June2021
c0_var <- var(save_c0)
c1_var <- var(save_c1)
c2_var <- var(save_c2)
c3_var <- var(save_c3)
...
# YW 26 June 2021: put results together and write to CSV file
# mean of bias
