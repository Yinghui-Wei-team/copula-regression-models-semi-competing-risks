...
out_file_estimates <- paste0("S2_misspec_underlying_normal_weibull_", part, ".csv")
...
for (i in 1:runs){
  ...
  if(i<101){ #1-100
    ...
    plnoptim_wei <- optim(c(0.67, -2.5, -0.6, 0.94, -3.3, -0.9, 0.4, 0.2), npl_wei, method="L-BFGS-B",
