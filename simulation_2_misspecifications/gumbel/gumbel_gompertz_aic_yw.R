...
out_file_summary <- "S2-misspecification - underlying gumbel gompertz - summary.csv"
out_file_estimates <-"S2-misspecification - underlying gumbel gompertz - estimates.csv"
...
for (i in 1:runs){
  ...
  ##################### Exponential ######################
  ########################################################
  # Likelihood function moved out of the loop by YW
  #rewritten by YW
