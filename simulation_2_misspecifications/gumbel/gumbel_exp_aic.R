...
# output files
out_file_summary <- "S2_misspec_underlying_gumbel_exp_summary.csv"
out_file_estimates <-"S2_misspec_underlying_gumbel_exp_estimates.csv"
...
# YW changed the starting values to between lower and upper 
...
# alpha1, a0, a1, alpha2, c0, c1, b0, b1
...
gumbel_wei_optim_starting_values =c(0.6, -3, 0.1, 0.6, -4, 1, -2, 1) # starting values 

# lower bound for b0 and b1 must be 0, because theta must be >=1 for gumbel
# gamma1, a0, a1, gamma2, c0, c1, b0, b1
...
print("Simulation 2 for gumbel exponential model completed successfully!")
