...
# what are these variables? put them into one lines
...
for (i in 1:runs){
  ...
  # commented out by YW to replace by the above lines - to shorten
  # a0_lw <- -10
  # a0_up <- -1
  # 
  # a1_lw <- -10
  ...
  # YW: the following lines would have been better written as vector to vector comparison
