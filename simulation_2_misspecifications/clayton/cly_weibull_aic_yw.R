...
for (i in 1:runs){
  ...
  # 
  # #cpl_wei(c(a1_up, x1_up, x2_up, a2_up, y1_up, y2_up, b0_up, b1_up),X=df$X, Y=df$Y, d1=df$d1, d2=df$d2, age=df$age)
  # 
  ...
  #                       lower=clayton_gom_optim_lower,upper=clayton_gom_optim_upper, 
  #                       X=df$X, Y=df$Y, d1=df$d1, d2=df$d2,age=df$age,
  #                       control=list(fnscale=-1),hessian=TRUE)
