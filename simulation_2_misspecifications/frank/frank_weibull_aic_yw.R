...
for (i in 1:runs){
  ...
  # Commented out by YW and rewritten as above
  # a0_lw <- -10
  # a0_up <- -2
  # a1_lw <- -10
  # a1_up <- 1.5
  ...
  # likelihoo function moved out of loop by YW
  ...
  # b1_up <- 8
  # 
  # plfoptim_wei <- optim(c(true_alpha1, true_x0, true_x1, true_alpha2, true_y0, true_y1, true_b0, true_b1), fpl_wei, method="L-BFGS-B",
