...
# normal weibull
df1 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weib_part1.csv"))
df2 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weib_part2.csv"))
df3 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weib_part3.csv"))
df4 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weib_part4.csv"))
df5 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weib_part5.csv"))
df6 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weib_part6.csv"))
df7 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weib_part7.csv"))
df8 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weib_part8.csv"))
df9 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weib_part9.csv"))
df10 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weib_part10.csv"))
