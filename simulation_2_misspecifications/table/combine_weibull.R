...
out_file_summary <- "simulation2/normal_weib/S2_aic_normal_weib_summary.csv"
...
true_alpha1 <- 0.67 #weib alpha1
true_alpha2 <- 1.03 #weib alpha2
true_x0 <- -2.68 #weib beta1
true_x1 <- 0.07 #weib beta1
true_y0 <- -4.38 #weib beta2
true_y1 <- 1.37 #weib beta2
...
# normal weibull
df1 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weibull_part1.csv"))
df2 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weibull_part2.csv"))
df3 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weibull_part3.csv"))
df4 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weibull_part4.csv"))
df5 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weibull_part5.csv"))
df6 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weibull_part6.csv"))
df7 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weibull_part7.csv"))
df8 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weibull_part8.csv"))
df9 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weibull_part9.csv"))
df10 <- read.csv(file=paste0(dir_results,"simulation2/normal_weib/S2_aic_normal_weibull_part10.csv"))
...
#hrs#
#bias
hr_l1_bias <- mean(bias_l1_hr)
hr_l2_bias <- mean(bias_l2_hr)
#coverage
hr_l1_cov <- (counter_hr_l1 / runs) * 100
hr_l2_cov <- (counter_hr_l2 / runs) * 100
#variance
hr_l1_var <- var(save_hr_l1)
hr_l2_var <- var(save_hr_l2)
#mse
...
#rho#
rho_d0_bias <- mean(bias_rho_d0)
rho_d1_bias <- mean(bias_rho_d1)
rho_d0_cov <- (counter_rho_d0 / runs) * 100 
rho_d1_cov <- (counter_rho_d1 / runs) * 100
rho_d0_var <- var(save_rho_d0)
rho_d1_var <- var(save_rho_d1)
