...
# normal gompertz
df1 <- read.csv(file=paste0(dir_results,"simulation2/normal_gomp/S2_aic_normal_gompertz_part1.csv"))
df2 <- read.csv(file=paste0(dir_results,"simulation2/normal_gomp/S2_aic_normal_gompertz_part2.csv"))
df3 <- read.csv(file=paste0(dir_results,"simulation2/normal_gomp/S2_aic_normal_gompertz_part3.csv"))
df4 <- read.csv(file=paste0(dir_results,"simulation2/normal_gomp/S2_aic_normal_gompertz_part4.csv"))
df5 <- read.csv(file=paste0(dir_results,"simulation2/normal_gomp/S2_aic_normal_gompertz_part5.csv"))
df6 <- read.csv(file=paste0(dir_results,"simulation2/normal_gomp/S2_aic_normal_gompertz_part6.csv"))
df7 <- read.csv(file=paste0(dir_results,"simulation2/normal_gomp/S2_aic_normal_gompertz_part7.csv"))
df8 <- read.csv(file=paste0(dir_results,"simulation2/normal_gomp/S2_aic_normal_gompertz_part8.csv"))
df9 <- read.csv(file=paste0(dir_results,"simulation2/normal_gomp/S2_aic_normal_gompertz_part9.csv"))
df10 <- read.csv(file=paste0(dir_results,"simulation2/normal_gomp/S2_aic_normal_gompertz_part10.csv"))
