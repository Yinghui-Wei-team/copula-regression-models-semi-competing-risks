...
out_file_summary <- "simulation2/normal_exp/S2_aic_normal_exp_summary.csv"
...
true_a0 <- -3.44 #exp lambda1
true_a1 <-  0.17 #exp lambda1
true_c0 <- -4.36 #exp lambda2
true_c1 <-  1.39 #exp lambda2
...
# normal exponential
df1 <- read.csv(file=paste0(dir_results,"simulation2/normal_exp/S2_aic_normal_exp_part1.csv"))
df2 <- read.csv(file=paste0(dir_results,"simulation2/normal_exp/S2_aic_normal_exp_part2.csv"))
df2 <- df2[101:200,]
df3 <- read.csv(file=paste0(dir_results,"simulation2/normal_exp/S2_aic_normal_exp_part3.csv"))
df3 <- df3[201:300,]
df4 <- read.csv(file=paste0(dir_results,"simulation2/normal_exp/S2_aic_normal_exp_part4.csv"))
df4 <- df4[301:400,]
df5 <- read.csv(file=paste0(dir_results,"simulation2/normal_exp/S2_aic_normal_exp_part5.csv"))
df5 <- df5[401:500,]
df6 <- read.csv(file=paste0(dir_results,"simulation2/normal_exp/S2_aic_normal_exp_part6.csv"))
df6 <- df6[501:600,]
df7 <- read.csv(file=paste0(dir_results,"simulation2/normal_exp/S2_aic_normal_exp_part7.csv"))
df7 <- df7[601:700,]
df8 <- read.csv(file=paste0(dir_results,"simulation2/normal_exp/S2_aic_normal_exp_part8.csv"))
df8 <- df8[701:800,]
df9 <- read.csv(file=paste0(dir_results,"simulation2/normal_exp/S2_aic_normal_exp_part9.csv"))
df9 <- df9[801:900,]
df10 <- read.csv(file=paste0(dir_results,"simulation2/normal_exp/S2_aic_normal_exp_part10.csv"))
df10 <- df10[901:1000,]
