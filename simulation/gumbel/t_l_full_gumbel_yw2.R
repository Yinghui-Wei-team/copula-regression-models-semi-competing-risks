...
# Gumbel copula exponential survival model - covairates on hazard rates
...
for (i in 1:runs){
  ...
  #                     true_b0, true_b1, true_b2, true_b3), gpl, method="L-BFGS-B", 
  ...
  # plgoptim <- optim( c(-6, -5, -5, -5, -6, -5, -5, -5,
  #                      2, 3, 5, 7), gpl, method="L-BFGS-B",
  #                   lower=c(a0_lw,a1_lw,a2_lw, a3_lw,c0_lw,c1_lw,c2_lw, c3_lw, b0_lw,b1_lw, b2_lw, b3_lw),
  #                   upper=c(a0_up,a1_up,a2_up, a3_up, c0_up,c1_up,c2_up,c3_up, b0_up,b1_up,b2_up, b3_up),
  #                   X=df$X, Y=df$Y, d1=df$d1, d2=df$d2, age.grp=df$age.grp, gen=df$gen,
  #                   donor=df$donor, control=list(fnscale=-1),hessian=TRUE)
  # 
  # 
  # initial values set to be those initial values in the estimation R file
 ...
 gpl(c(a0_lw,a1_lw,a2_lw, a3_lw,c0_lw,c1_lw,c2_lw, c3_lw, b0_lw,b1_lw, b2_lw, b3_lw), X=df$X, Y=df$Y, d1=df$d1, d2=df$d2, age.grp=df$age.grp, gen=df$gen, donor=df$donor)
...
setwd("C:/Users/ywei3/University of Plymouth/Lexy Sorrell - Lexy's Work/R/NHSBT/Covariates/Simulations")

write.csv(Results, row.names=F,file="Results/S1-Table5-gumbel-exponential-covariates-hazards-association.csv")
...
write.csv(Estimates, row.names=F,file="Results/S2-gumbel-exponential-covariates-for-hazards-estimates.csv")
